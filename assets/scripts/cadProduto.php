<?php
    ...
    $sqlInsert = "INSERT INTO produto (nome, preco, pontos, marca, descricao, caminho_imagem, TG_categoria) VALUES ('$nome', $preco, '$pontos', '$marca', '$descricao', '$caminhoBD', '$categoria')";
