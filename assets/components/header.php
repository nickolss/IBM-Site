    ...
    <header>
        <div class="pai__header">
            <div class="filho__header">
                ...
                <div>
                    <ul class="paginas">
                        <li class="opcoes__paginas"><a class="hyperlink__paginas" href="personalizacoes.php">Personalizações</a></li>
                        <li class="opcoes__paginas"><a class="hyperlink__paginas" href="produtos.php">Produtos</a></li>
                        <li class="opcoes__paginas"><a class="hyperlink__paginas" href="aboutus.php">Sobre Nós</a></li>
                    </ul>
                </div>
