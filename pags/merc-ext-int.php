			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/carro-p.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Personalizações externas e internas</h1>
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$5.999,99</h2>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/carro-p.svg">
					</div>
					<br>
					<br>
					<div>
