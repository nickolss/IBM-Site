...
<head>
  ...
  <title>Turn Motors | Intalador de alarme</title>
...
<body>
  ...
  <main class="main-vaga">
    <div class="container text-center">
      <div class="row">
        <div class="col">
          <h1 class="title-vaga-mecanico">Instalador de alarme</h1>
        </div>
      </div>
      <hr>
      <br>
      ...
      <div class="row">
        <div class="col">
          ...
          <p class="p-vaga-mecanico">Atua com instalação e manutenção de alarmes monitorados e CFTV digital. Faz passagem de cabeamento, reparos e faz elaboração de laudos técnicos.</p>
        </div>
      </div>
      <br>
      <br>
      ...
      <div class="row">
        <div class="col">
          ...
          <div style="text-align: center;">
            ...
            <p style="font-size: 1.5em;"><img src="../assets/img/dindin.svg" class="img-fluid" alt="Dinheiro"> De R$1900,00 a R$2400,00</p>
        ...
        <div class="col">
          ...
          <div style="display: flex; justify-content: center;">
            <div style="width: 950px; ">
              <ul>
                <li class="li-vaga-mec">Escolaridade Ensino Médio completo.</li>
                <li class="li-vaga-mec">Experiência em instalação de sistemas de alarme.</li>
                <li class="li-vaga-mec">Experiência com montagem de equipamentos fabricados pela empresa.</li>
      ...
      <div class="row">
        <div class="col">
          <img style="width: 650px;" src="../assets/img/alarme-automotivo-instalacao.jpg" class="img-fluid img-vaga" alt="Funilaria">
        </div>
      </div>
    </div>
    <div class="col">
