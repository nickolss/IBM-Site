...
<head>
  ...
  <title>Turn Motors | Operador Injeção</title>
...
<body>
  ...
  <main class="main-vaga">
    <div class="container text-center">
      <div class="row">
        <div class="col">
          <h1 class="title-vaga-mecanico">Operador de Injetora</h1>
        </div>
      </div>
      <hr>
      <br>
      ...
      <div class="row">
        <div class="col">
          ...
          <p class="p-vaga-mecanico">Realizar eventualmente inspeção na máquina injetora e compressora de borracha, abastecer os materiais, inspecionar e embalar as peças, operar máquina injetora e compressora de borracha, e realizar limpeza e conservação da máquina e setor onde trabalha.</p>
        </div>
      </div>
      <br>
      <br>
      ...
      <div class="row">
        <div class="col">
          ...
          <div style="text-align: center;">
            <p style="font-size: 1.5em;"><img src="../assets/img/calendario.svg" class="img-fluid" alt="Calendário">Segunda à sexta das 09h às 18h.</p>
      ...
      <div class="row">
        <div class="col">
          <img src="../assets/img/tecnologia-na-oficina-600x375.jpg" class="img-fluid img-vaga" alt="Funilaria">
        </div>
      </div>
    </div>
    <div class="col">
