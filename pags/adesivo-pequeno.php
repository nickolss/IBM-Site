...
<head>
    ...
    <title>Turn Motors | Adesivo Pequeno</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Adesivo Pequeno</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'adesivo-pequeno';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Adesivo Pequeno"></div>';
