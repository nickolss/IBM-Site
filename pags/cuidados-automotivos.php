...
<head>
    ...
    <title>Turn Motors | Cuidados Automotivos</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Cuidados Automotivos</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'cuidados-automotivos';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Cuidados Automotivos"></div>';
