...
<body id="container__body">
    ...
    <main class="principal">
        <div class="titulo">
            <h1 class="mainTitle">Orçamentos Pendentes</h1>
        </div>
        ...
        <div class="card-container">
            ...
            if ($quantidadeTupla > 0) {
                foreach ($pedidos as $pedido) {
                    if ($pedido['status'] == 'mecanico confirmado') {
            ...
            ?>
                        ...
                        <form action="../assets/scripts/confirmarAgendamento.php?placa=<?= $placa ?>" method="post">
                            <div class="card">
                                <div class="card-info">
                                    ...
                                    <p class="text-body">Preço: R$<?= $preco ?></p>
                                </div>
