...
<head>
    ...
    <title>Turn Motors | Óleos e Fluidos</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Óleos e Fluidos</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'oleo-fluidos';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Óleos e Fluidos"></div>';
