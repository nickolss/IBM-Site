...
<head>
    ...
    <title>Turn Motors | Pneu Duas Cores</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Pneu Duas Cores</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'pneu-duasCores';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Pneu duas Cores"></div>';
