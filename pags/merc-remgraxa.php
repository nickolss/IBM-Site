			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="250px" src="../assets/img/removedor-graxa.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Removedor de Graxa</h1>
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$35,00</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;"> Fórmula inovadora excepcional para remoção de graxa e piche. é a maneira mais eficiente e segura para limpeza de motor, kit de transmissão, pintura e demais partes do automóvel.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/removedor-graxa.svg">
					</div>
					<br>
					<br>
					<div>
