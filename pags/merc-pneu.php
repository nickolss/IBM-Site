			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/pneu-personalizavel.png">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Pneu Personalizavél</h1>
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$800</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;">Se você busca inovar no estilo com o seu pneu, adquira já um pneu personalizavél. Você, cliente Turn Motors, pode escolher como a personalização será e tudo isso com a garantia que o o pneu além de lindo, terá um selo de qualidade Turn Motors.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/pneu-personalizavel.svg">
					</div>
					<br>
					<br>
					<div>
