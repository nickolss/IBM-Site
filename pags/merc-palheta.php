			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/palheta.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$25,00</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;">Palhetas Flexíveis de Silicone com as seguintes características: Facilidade de Instalação, não risca o Para-Brisa, Não Enferruja, Sem Ruídos, Estilo Moderno, Grande Durabilidade. Essencial para os dias de chuva.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/palheta.svg">
					</div>
					<br>
					<br>
					<div>
