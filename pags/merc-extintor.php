			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="250px" src="../assets/img/extintor.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Extintor Automotivo</h1>
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$90,00</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;">Manufatura do cilindro de alumínio leve. Cilindro de alumínio revestido com pimenta para proteção contra corrosão. Multiplicação de produtos químicos secos abc, combate todos os tipos de fogo (lixo, madeira, papel, líquidos, equipamentos elétricos). O design do tamanho do gancho é portátil e fácil de transportar.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/extintor.svg">
					</div>
					<br>
					<br>
					<div>
