    ...
    <?php
        ...
        if ($quantidadeTupla > 0) {
            for($i=0; $i < count($rows); $i++){
                ...
                echo    '<div class="tela__media">';
                echo        '<div class="container__card">';
                echo            '<div class="card card__maior">';
                echo                '<div class="card__img">';
                echo                    '<img class="card__img__rebaixamento" src="#" alt="Img Pneu Sólido">';
                echo                '</div>';
                echo                '<div class="card__titulo">';
                echo                    '<h3>' . $nome . '</h3>';
                echo                '</div>';
