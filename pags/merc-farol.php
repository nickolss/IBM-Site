			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/farol.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$300,00</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;"> O Kit de Lâmpadas Turn Motors é a opção perfeita para personalizar o veículo com qualidade e praticidade. Sem a necessidade de grandes adaptações, esse acessório proporciona iluminação e estilo similares ao Xenon de 6000K, com a mesma tonalidade branca levemente azulada.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/farol.svg">
					</div>
					<br>
					<br>
					<div>
