        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p class="fs-4 subtitle-equipe2023">A Turn Motors possui um time capacitado de desenvolvedores com o objetivo de oferecer a melhor interatividade e entendimento dos seus usuários. Abrangendo todas as áreas de linguagem de programação para que nossos usuários saiam com suas expectativas realizadas e seu pedido realizado dentro do conforto de seu lar.</p>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col equipe">
                    <img src="../assets/img/pedro.jpg" class="" alt="Especialista em Design Turn Motors">
                    <div class="informacoes">
                        <h3 class="informacoes__cargo">Desenvolvedor Front-end</h3>
                        <h2 class="informacoes__nome">Pedro Fernandes</h2>
                        <p class="informacoes__carreira">Administrador das Mídias Sociais e Designer</p>
                    </div>
                </div>
                <div class="col equipe">
                    <img src="../assets/img/nickolas.jpg" class="" alt="Administrador do banco de dados e Especialista em PHP Turn Motors">
                    <div class="informacoes">
                ...
                <div class="col equipe">
                    <img src="../assets/img/vini.jpg" class="" alt="Especialista em JavaScript Turn Motors">
                    <div class="informacoes">
                        <h3 class="informacoes__cargo">Desenvolvedor Back-end</h3>
            ...
            <div class="row">
                <div class="col equipe">
                    <img src="../assets/img/tiago.jpg" class="" alt="Especialista em Front-end Turn Motors">
                    <div class="informacoes">
                        <h3 class="informacoes__cargo">Desenvolvedor Front-end</h3>
                ...
                <div class="col equipe">
                    <img src="../assets/img/miguel.jpg" class="" alt="Tester Turn Motors">
                    <div class="informacoes">
