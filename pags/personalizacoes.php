...
<body id="container__body">
  ...
  <main>
        ...
        <div class="linha__cards">
            ...
            <div class="cards">
                <div class="card">
                    <a href="produtos-categoria.php?categoria=PNS" class="a__card">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=PNP" class="a__card">
                        <div class="div__card__img__pneu">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=PND" class="a__card">
                        <div class="div__card__img__pneu">
        ...
        <div class="linha__cards">
            ...
            <div class="cards">
                <div class="card">
                    <a href="produtos-categoria.php?categoria=AP" class="a__card">
                        <div class="card__img">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=AM" class="a__card">
                        <div class="card__img">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=AG" class="a__card">
                        <div class="card__img">
        ...
        <div class="linha__cards">
            ...
            <div class="cards cards2">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=VD" class="a__card">
                        <div class="card__img">
        ...
        <div class="linha__cards">
            ...
            <div class="cards cards2">
                <div class="card">
                    <a href="produtos-categoria.php?categoria=CS" class="a__card">
                        <div class="card__img">
                ...
                <div class="card">
                    <a href="produtos-categoria.php?categoria=BC" class="a__card">
                        <div class="card__img">
