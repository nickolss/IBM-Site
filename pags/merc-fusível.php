			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/fusivel.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Fusível Automotivo</h1>
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$1,00 (unidade)</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;"> O fusível é muito importante para a segurança do automóvel, pois basta qualquer ameaça de curto-circuito que eles interrompem a energia.
							Por isso, eles são fundamentais e devem ser substituídos sempre que apresentarem algum defeito.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/fusivel.svg">
					</div>
					<br>
					<br>
					<div>
