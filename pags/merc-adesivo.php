			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/adesivo.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						...
						<h2 style="margin-top: 10px; font-weight: bold;">R$200,00</h2>
						<h3 style="font-weight: bold;">Sobre este item:</h3>
						<p style="font-size: 1.1em;">Se você busca inovar no estilo do seu veículo, mas sem alterar muito, adquira já adesivo. Você, cliente Turn Motors, pode escolher como será o adesivo, com a garantia que o adesivo não poderá estragar a lataria de seu automóvel.</p>
