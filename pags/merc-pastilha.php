			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="650px" src="../assets/img/pastilha-freio.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Pastilha de Freio</h1>
						...
						<p style="font-size: 1.1em;"> As pastilhas de freio têm a função de gerar atrito para desacelerar e parar o veículo. Para isso, elas trabalham em conjunto com o disco de freio.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/pastilha-freio.svg">
					</div>
					<br>
					<br>
					<div>
