			...
			<div class="row" id="correcao">
				<div class="col-7">
					<div id="box" style="text-align: end; margin: 70px 0px; margin-left: 95px;">
						<img class="vg-img" id="img-adesivo" width="450px" src="../assets/img/oleo.svg">
				...
				<div class="col">
					<div style="margin-top: 75px; margin-right: 170px;">
						<h1 class="vg-tite">Óleo de Motor</h1>
						...
						<p style="font-size: 1.1em;"> Lubrificante multiviscoso, 100% sintético de última geração, desenvolvido de acordo com os requerimentos dos mais modernos veículos do mercado movidos a gasolina, etanol, bicombustível e gnv.</p>
			...
			<div class="row">
				<div class="col alinhar">
					<div class="" id="box1" style="margin-top: 50px;">
						<img class="vg-img1 img-fluid " src="../assets/img/oleo.svg">
					</div>
					<br>
					<br>
					<div>
