...
<head>
    ...
    <title>Turn Motors | Pneu Personalizado</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Pneu Personalizado</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'pneu-personalizado';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Pneu Personalizado"></div>';
