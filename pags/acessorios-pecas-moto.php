...
<head>
    ...
    <title>Turn Motors | Acessórios e Peças para Motos</title>
</head>
<body id="container__body">
    ...
    <main>
        <div class="main__title">
            <h1>Acessórios e Peças para Motos</h1>
        </div>
        <div class="card-container">
            <?php
                $categoria = 'acessorios-pecas-moto';
                ...
                if ($quantidadeTupla > 0) {
                    for($i=0; $i < count($rows); $i++){
                        ...
                        echo '<div class="card">';
                        echo    '<div class="card-img"><img id="produto__img" src="../assets/img/#" alt="Img Acessorios e Peças p/ Motos"></div>';
